...
insert into company_division values ('Automotive','Auto & Hardware');
insert into company_division values ('Baby','Domestic');
insert into company_division values ('Beauty','Domestic');
insert into company_division values ('Clothing','Domestic');
insert into company_division values ('Computers','Electronic Equipment');
insert into company_division values ('Electronics','Electronic Equipment');
insert into company_division values ('Games','Domestic');
insert into company_division values ('Garden','Outdoors & Garden');
insert into company_division values ('Grocery','Domestic');
insert into company_division values ('Health','Domestic');
insert into company_division values ('Home','Domestic');
insert into company_division values ('Industrial','Auto & Hardware');
insert into company_division values ('Jewelery','Fashion');
insert into company_division values ('Kids','Domestic');
insert into company_division values ('Movies','Entertainment');
insert into company_division values ('Music','Entertainment');
insert into company_division values ('Outdoors','Outdoors & Garden');
insert into company_division values ('Shoes','Domestic');
insert into company_division values ('Sports','Games & Sports');
insert into company_division values ('Tools','Auto & Hardware');
insert into company_division values ('Toys','Games & Sports');
...
insert into company_region values (1, 'Northeast', 'USA');
insert into company_region values (2, 'Southeast', 'USA');
insert into company_region values (3, 'Northwest', 'USA');
insert into company_region values (4, 'Southwest', 'USA');
insert into company_region values (5, 'British Columbia', 'Canada');
insert into company_region values (6, 'Quebec', 'Canada');
insert into company_region values (7, 'Nova Scotia', 'Canada');
